<style>
    #oauth2-gitlab-signin-button.persona-button span::before {
        background: #fff;
    }
    ...
    #oauth2-gitlab-signin-button.persona-button::before {
        background: #fff;
    }
</style>
<div class="logindiv openid_container" id="oauth2_gitlab_openid_container" style="display: block;">
    <div style="text-align: center;">
        ...
        <?php endif; ?>
        <a class="persona-button large orange" id="oauth2-gitlab-signin-button" href="<?= make_url('oauth2_gitlab_login'); ?>"><span><?php echo empty($gitlab_btn_label) ? __('Use GitLab') : $gitlab_btn_label; ?></span></a>
    </div>
</div>